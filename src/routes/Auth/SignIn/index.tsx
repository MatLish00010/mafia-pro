...
const Auth = () => {
  ...
  return (
    <section className="flex-1 flex flex-col justify-center items-center gap-5">
      <h1>Login</h1>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onLogin)} className="w-2/3 space-y-6 max-w-64">
          <FormField
            ...
            render={({field}) => (
              <FormItem>
                ...
                <FormControl>
                  <Input required type="email" placeholder="email@gmail.com" {...field} />
                </FormControl>
          ...
          <FormField
            ...
            render={({field}) => (
              <FormItem>
                ...
                <FormControl>
                  <Input required type="password" placeholder="not 1234" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
