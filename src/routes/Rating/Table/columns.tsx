...
export const columns: ColumnDef<RatingPlayer & { nick: User["nick"] }>[] = [
	...
	},
	{
		...
		cell: (props) => (
			<div className="text-center">{props.row.getValue("countOfGames")}</div>
		),
	},
	{
		...
		cell: (props) => (
			<div className="text-center">{props.row.getValue("winGames")}</div>
		),
	},
	{
		...
		cell: (props) => (
			<div className="text-center">{props.row.getValue("loseGames")}</div>
		),
	},

	{
		...
		cell: (props) => (
			<div className="text-center">{props.row.getValue("handLose")}</div>
		),
	},
	{
		...
		cell: (props) => (
			<div className="text-center">{props.row.getValue("breakLose")}</div>
		),
	},
	{
		accessorKey: "removed",
		...
		cell: (props) => (
			<div className="text-center">{props.row.getValue("removed")}</div>
		),
	},
	{
		accessorKey: "sum",
		...
		cell: (props) => (
			<div className="text-center">{props.row.getValue("sum")}</div>
		),
	},
];
